...
print(y_train.shape, y_test.shape)   # (50000, 10)         (10000, 1)
...
# x_img = tf.reshape(x, [-1, 32, 32, 3])                  # input_shape
...
w1 = tf.get_variable('w1', shape=[3, 3, 3, 32])  # [kernel_size, kernel_size, color, output]
print(w1)                                        # (3, 3, 3, 32)
...
print('Acc :', sess.run(accuracy, feed_dict = {x:x_test, y:y_test, keep_prob:1}))        # Acc : 0.6674