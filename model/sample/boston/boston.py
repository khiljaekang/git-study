...
# model.save('./model/sample/boston/boston_model_test01.h5')
...
modelpath = './model/sample/boston/boston_check-{epoch:02d} - {val_loss:.4f}.hdf5'
...
# model.save_weights('./model/sample/boston/bostonsave_weight1.h5')
