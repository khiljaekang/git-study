...
# model.save('./model/sample/mnist/mnist_model_test01.h5')
...
modelpath = './model/sample/mnist/mnist_check-{epoch:02d} - {val_loss:.4f}.hdf5'
checkpoint = ModelCheckpoint(filepath=modelpath, monitor='val_loss', verbose = 1,
                                  save_best_only=True, save_weights_only=False)

hist = model.fit(x_train, y_train, epochs= 10, batch_size= 64,callbacks = [checkpoint] ,
                 validation_split=0.2)


  

# model.save_weights('./model/sample/mnist/mnistsave_weight1.h5')
