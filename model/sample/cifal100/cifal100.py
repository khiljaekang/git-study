...
# model.save('./model/sample/cifal100/cifal100_model_test01.h5')
...
modelpath = './model/sample/cifal100/cifal100_check-{epoch:02d} - {val_loss:.4f}.hdf5'
...
model.save_weights('./model/sample/cifal100/cifal100save_weight1.h5')
