...
# model.save('./model/sample/iris/iris_model_test01.h5')
...
modelpath = './model/sample/iris/iris_check-{epoch:02d} - {val_loss:.4f}.hdf5'
...
# model.save_weights('./model/sample/iris/irissave_weight1.h5')
