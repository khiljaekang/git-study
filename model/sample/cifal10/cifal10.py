...
# model.save('./model/sample/cifal10/cifal_model_test01.h5')
...
modelpath = './model/sample/cifal10/cifal10_check-{epoch:02d} - {val_loss:.4f}.hdf5'
...
# model.save_weights('./model/sample/cifal10/cifal10save_weight1.h5')              
