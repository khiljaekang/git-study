...
np.save('./data/mnist_train_x.npy', arr = x_train)    ##nummy형에는 다른자료형은 올수 없다. 
np.save('./data/mnist_train_y.npy', arr = y_train)    ##자료형에 유연한 유형은 pandas!!!!!!!!!!!!
...
model = load_model('./model/check-07 - 0.0583.hdf5')
