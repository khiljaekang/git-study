...
dense1_1 = Dense(80, activation='relu', name='dense1_2')(dense1_1)
dense1_1 = Dense(100, activation='relu', name='dense1_3')(dense1_1)
dense1_2 = Dense(120, activation = 'relu')(dense1_1)
   

######### 모델 2 #########
input2 = Input(shape =(3,1)) 
dense2_1 = LSTM(60, activation='relu', name='dense2_1')(input2)
dense2_1 = Dense(80, activation='relu', name='dense2_2')(dense2_1)
dense2_1 = Dense(100, activation='relu', name='dense2_3')(dense2_1)
dense2_2 = Dense(120, activation = 'relu')(dense2_1)
...
model.fit([x1, x2], y, epochs =800, batch_size = 32, verbose=2#,callbacks = [es] 
          )                 
