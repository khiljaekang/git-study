...
dense1 = Dense(110, activation = 'relu')(dense2)
dense2 = Dropout(0.2)(dense1)

dense1 = Dense(90, activation = 'relu')(dense2)
dense2 = Dropout(0.2)(dense1)

dense1 = Dense(70, activation = 'relu')(dense2)
dense2 = Dropout(0.2)(dense1)

dense1 = Dense(50, activation = 'relu')(dense2)
dense2 = Dropout(0.2)(dense1)

dense1 = Dense(40, activation = 'relu')(dense2)
dense2 = Dropout(0.2)(dense1)

dense1 = Dense(30, activation = 'relu')(dense2)
dense2 = Dropout(0.2)(dense1)

dense1 = Dense(20, activation = 'relu')(dense2)
dense2 = Dropout(0.2)(dense1)
