...
def autoencoder(hidden_layer_size):
    ...
    model.add(Conv2D(filters =32, kernel_size=(3,3), padding ='valid',
               activation='relu'))
    model.add(Conv2DTranspose(filters =64, kernel_size=(3,3), padding ='valid',
               activation='relu'))
    
    model.add(Conv2DTranspose(filters= 128, kernel_size=(3,3), padding='valid',
               activation='relu'))
    model.add(Conv2DTranspose(filters= 256, kernel_size=(3,3), padding='valid',
               activation='relu'))
...
model.compile(optimizer = 'adam', loss = 'binary_crossentropy', metrics = ['acc'])  # loss: 0.0935 -
