...
from tensorflow.keras.applications import DenseNet169, DenseNet201, NASNetMobile, MobileNet,Xception,ResNet101V2,InceptionV3, ResNet50
...
# model
takemodel = MobileNet(include_top=False, input_shape = (128, 128, 3),)
...
cp = ModelCheckpoint('D:/teamproject/checkpoint/mobilenet_128.hdf5', monitor = 'val_loss',
