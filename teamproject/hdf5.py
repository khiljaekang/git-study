...
def load_image(path, w, h):   # 폴더별로 이미지 불러오고 labeling
    ...
    hdf = h5py.File('D:/teamproject/data/70400.hdf5', 'a')
    del hdf['70400']
    imageset = hdf.create_dataset('70400', (70400, w, h, 3), maxshape=(None, w, h, 3))

    i = 0
    
    for folder in folder_name:
        
        image_dir = path + '/'+ folder + '/'  + folder + '/' #불러올 이미지 경로
